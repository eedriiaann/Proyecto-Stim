...
public class ChartView implements Serializable {
    ...
    //Este metodo lo habria utilizado en la tabla de precios pero no me ha dado tiempo a implementarla
    public void createLineModel() {
        lineModel = new LineChart()
                .setData(new LineData()
                        .addDataset(new LineDataset()
                                .setData(15, 15, 5, 15, 15, 10,
                                        15, 15, 10, 15, 15, 5,
                                        5, 15, 15, 15, 10, 15,
                                        15, 5, 15, 15, 10, 15,
                                        15)
                        ...
                        .setLabels("January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December", "Current"))
